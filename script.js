...
// dit is het pad
    var startPos = new Vector(0, 625); //dit is de start van het pad en de leerling
    var pathData = [
        new Vector(400, 0),// 400px naar recht
        new Vector(0, -200),// naar boven
        new Vector(100, 0),// naar rechts
        new Vector(0, -100),
        new Vector(200, 0),
        new Vector(0, 100),
        new Vector(200, 0),
    ...
    //de leerlingen die spawnen als enemeys
    let leerlingen = [];
...
setInterval(function(){
    let healhvariable = document.getElementById("health")
    healhvariable.value = enemy1health
